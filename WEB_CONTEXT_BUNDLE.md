...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-866-erd-s-problem-866-19ba1985-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-866"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-866-erd-s-problem-866-19ba1985-v1",
      "problem_contract_sha256": "07bff46ecf7c7297e86235ad360430ae2d6e2c10aa1224e3b90584585889dad3",
      "problem_id": "problem:um-ep-866-erd-s-problem-866-19ba1985",
      "route_id": "route:um-ep-866-erd-s-problem-866-19ba1985-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-866-erd-s-problem-866-19ba1985-source-fidelity-01",
      "graph_id": "graph:um-ep-866-erd-s-problem-866-19ba1985-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-866-erd-s-problem-866-19ba1985-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-866-erd-s-problem-866-19ba1985-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k\\geq 3$ and $g_k(N)$ be minimal such that if $A\\subseteq \\{1,\\ldots,2N\\}$ has $\\lvert A\\rvert \\geq N+g_k(N)$ then there exist integers $b_1,\\ldots,b_k$ such that all $\\binom{k}{2}$ pairwise sums are in $A$ (but the $b_i$ themselves need not be in $A$). Estimate $g_k(N)$."
          },
          "statement_sha256": "fb3b6b8d9f7c9f430196f27cac4d23eb77874510acd1c5c8ca33f145d62f4322"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-866-erd-s-problem-866-19ba1985-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-866-erd-s-problem-866-19ba1985-root",
      "route_id": "route:um-ep-866-erd-s-problem-866-19ba1985-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-866-cb13fe07e707",
        "url": "https://www.unsolvedmath.com/problems/EP-866"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
